function [x,y,t,u,v,p,Bx,By] = mhd_rk_generator(_omega, _A, _forcing, n, dt, timesteps, nu, eta, lorentz, skip, butcher, vis)
    % generates runge-kutta methods for MHD from a butcher tableau
    ...
    for t = 1:timesteps
        ...
        for i = 1:skip
            [omega, A] = transform_fields(f, omega, A, dt, butcher);
        end
...
function [omega_P, A_P] = transform_fields(f, omega, A, dt, butcher)
